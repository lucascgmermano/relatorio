...
do agravo durante durante a pandemia. Os dados foram agrupados por
data, município, distribuição geográfica e grupos etários. São
apresentadas frequências absolutas dos `casos`, `óbitos`,
`taxa de incidência` e `taxa de letalidade` ([*ver definições*](formulas.html)).
