...
Durante o ano de 2022 foram notificados **`r sum(dd22$casos)/1000`** casos e **`r sum(dd22$obitos)`** óbitos, o que correspondeu à taxa de incidência de **`r round(sum(dd22$casos)/830499*100000, 0)`** casos por 100 mil habitantes e à taxa de letalidade de **`r round(sum(dd22$obitos)/sum(dd22$casos)*100, 0)`%** entre os doentes. A seguir são apresentados os dados sobre a ocorrência dos casos e óbitos, distribuição espacial do Covid-19 e as coberturas vacinais detalhadas:
