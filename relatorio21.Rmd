---
title: "Covid-19 e coberturas vacinais: <Br> Relatório 2021"
...
ggplot(graf)+
  ...
  scale_y_continuous(sec.axis = sec_axis(~./35, name = "Cobertura (%)", breaks = seq(0,100,5)))+
...
ggplot(graf)+
  ...
  scale_fill_manual(breaks = c('Cobertura de D1','Cobertura de D2',"Dose adicional"))+
  scale_x_date(date_breaks = "1 month", date_labels = "%b")+
  scale_y_continuous(sec.axis = sec_axis(~.*4, name = "Cobertura (%)", breaks = seq(0,100,5)))+
...
ggplot(graf)+
  ...
  scale_fill_manual(breaks = c('Cobertura de D1','Cobertura de D2',"Dose adicional"))+
  scale_x_continuous(breaks = seq(1,53,4))+
  scale_y_continuous(sec.axis = sec_axis(~./1.5, name = "Cobertura (%)", breaks = seq(0,100,5)))+
...
ggplot(graf, aes(group=1))+
  ...
  scale_fill_manual(breaks = c('Cobertura de D1','Cobertura de D2',"Dose adicional"))+
  scale_x_discrete(limits = c("jan","fev","mar","abr" , "mai","jun", "jul","ago","set","out","nov","dez"))+
  scale_y_continuous(sec.axis = sec_axis(~./10, name = "Cobertura (%)", breaks = seq(0,100,5)))+
...
cat(paste("####",i,"\n\n"))
  ...
  left_join(tabyl(subset(ddvac, muni==i), cat.pop.etaria, dose),
    ...
    kable(col.names = c("Faixa etária", "População", "D1", "D2", "D3", "Cob.D1", "Cob.D2", "Cob.D.Adic"),
          caption = i) %>%
    kable_styling(full_width = F,
                  bootstrap_options = c("striped", "hover",
                                        "condensed", "responsive")) )
